...
export const metadata: Metadata = {
  ...
  description: 'Learn how to index your website on 22 search engines using Indexly.',
}
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px' }}>
        <div style={{ marginBottom: 48 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 800, marginBottom: 12, lineHeight: 1.2 }}>
            Get Your Website Indexed<br />on 22 Search Engines
          </h1>
        ...
        <Section title="How It Works">
          ...
          <Step n={3} title="Verify & get indexed everywhere">Click Verify. Indexly scans your website, confirms ownership, and submits it across the search engine network — covering all 22 platforms at once.</Step>
        ...
        <Section title="Analytics Features">
          <AnalyticsItem icon="🔍" title="Search Engine Coverage" desc="See which of the 22 search engines are showing your website and how much traffic each one drives." />
        ...
        <Section title="Frequently Asked Questions">
          ...
          <FAQ q="Do I need separate accounts on each search engine?" a="No. That is the entire point of Indexly — submit once and we distribute across all 22 engines for you." />
          <FAQ q="Which search engines are covered?" a="Google, Bing, Yandex, Naver, Seznam.cz, Yep, Yahoo!, AOL, DuckDuckGo, Ecosia, Swisscows, Lycos, Dogpile, WebCrawler, Excite, Ekoru, GiveWater, Lilo, Startpage, Ask.com, Info.com and Gibiru — 22 in total. See the full list with details on the homepage." />
