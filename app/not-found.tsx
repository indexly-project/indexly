  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <div className="page-center" style={{ flex: 1, flexDirection: 'column', gap: 0, textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: 15, marginBottom: 28, maxWidth: 360 }}>The page you are looking for does not exist or has been moved.</p>
        ...
        <p style={{ marginTop: 24, fontSize: 13, color: 'var(--muted)' }}>Need help? <a href="mailto:indexlyproject@gmail.com">indexlyproject@gmail.com</a></p>
      </div>
      <Footer />
    </div>
  )
