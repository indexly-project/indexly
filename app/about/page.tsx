  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '48px 24px', flex: 1 }}>
        ...
        <p style={{ color: 'var(--muted)', lineHeight: 1.7, marginBottom: 24 }}>A developer or website owner needs to separately verify on multiple search engines. Each has its own flow, its own verification method, its own dashboard. Indexly unifies all of this into a single 2-step process covering 16 search engines at once.</p>
